              ...
              <div class="card card-login mx-auto mt-8 ">
                  ...
                  <form>
                    <div class="form-group">
                      <p>We trust you and willing to help. please enter your email address used on our system. And we will send your password</p>
                      <div class="form-label-group">
                        ...
                        <div class="form-group">
                                            <!-- this is loading div -->
                                            <div id= "reg_wait" style="position:absolute; display: none;  top:0px; left:0px; width:100%; height:100%;background-color: rgba(0, 0, 0, 0.385); z-index: 11; ">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" style="border-radius:10px;">send request</button>
                    </form>
