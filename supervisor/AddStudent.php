      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="col-lg-12 text-right" style="margin-top:5px;" >
              <button type="button" data-toggle="modal" data-target="#SuperModol" class="btn btn-info btn-sm">New Student</button>
          </div>
          <div class="card-body" id="projectDiv">
            <div class="table-responsive " id="tabletable">

                <?php  require("viewStudent.php"); ?>

            </div>
          </div>
          <div class="card-footer small text-muted">Student</div>
        </div>
  ...
  <div class="modal fade" id="SuperModol" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form class="form-horizontal" onsubmit = "return  RegisterStudent()">
        ...
        <div class="form-inline" style="margin-left:5%;">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="st_id" placeholder="enter  student ID" required>
                </div>
            </div>
            <div class="form-group">
                <label for="mname" class="col-sm-4 control-label">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="prog_ID" class="form-control" required>
                            <?php
                              $d_query = "SELECT prog_ID FROM Program WHERE 1;";
                              $run_d_query = mysqli_query($conn,$d_query);
                              while($prog = mysqli_fetch_assoc($run_d_query)){
                                  $prog_ID = $prog['prog_ID'];
                                  echo "<option value='{$prog_ID}'>{$prog_ID}</option>";
                            }
                            ?>
                    </select>
                </div>
        ...
        <div class="form-group" style=" margin-top:20px; margin-left:1%;">
            <div class="form-group">
                <label class="col-sm-4" >Study year:</label>
                <div class="col-sm-9">
                <input type="text" class="form-control" name="study_year" placeholder="your Study year" required>
                </div>
            </div>
        </div>
